"""
    ...
    Generate API URL with the following parameters:
        Number of Questions: 10
        Select Category: Science: Computers
        Select Difficulty: easy
        Select Type: True / False
        Select enconding: Default Encoding

    Open the URL generate:
        https://opentdb.com/api.php?amount=10&category=18&difficulty=easy&type=boolean

    Copy and Paste JSON code bellow on question_data
        remember of delete the beginning dictionary of JSON
        {"response_code":0,"results":
        delete the last } in the end of the dictionary
"""
